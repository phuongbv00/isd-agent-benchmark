...
Reads the output of scripts/alignmentgraph-isd-bench/7_pool_ladder_runs.py and writes into
...
def header_comment(pooled: dict, what: str) -> str:
    ...
    lines = [
        f"% AUTO-GENERATED by isd-agent-benchmark/scripts/alignmentgraph-isd-bench/8_gen_paper_tables.py — DO NOT EDIT BY HAND",
        f"% {what}",
    ...
    if not align or not align.get("models"):
        return (header_comment(pooled, "tab_rq2_alignment.tex — placeholder")
                + "% No alignment_scores.json data was present in the pooled input.\n"
                  "% Re-run scripts/alignmentgraph-isd-bench/7_pool_ladder_runs.py after the alignment metric\n"
